...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'wirm_comment', (
            ...
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wirm.Parameter'])),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='comments', to=orm['auth.User'])),
            ('submit_date', self.gf('django.db.models.fields.DateTimeField')(default=None, auto_now_add=True, blank=True)),
    ...
    models = {
        ...
        u'wirm.comment': {
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['wirm.Parameter']"}),
