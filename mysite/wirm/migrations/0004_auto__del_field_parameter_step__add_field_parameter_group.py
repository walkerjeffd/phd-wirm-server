...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Parameter.step'
        db.delete_column(u'wirm_parameter', 'step')

        # Adding field 'Parameter.group'
        db.add_column(u'wirm_parameter', 'group',
                      self.gf('django.db.models.fields.CharField')(default='basic', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Parameter.step'
        db.add_column(u'wirm_parameter', 'step',
                      self.gf('django.db.models.fields.FloatField')(default=0.01),
                      keep_default=False)

        # Deleting field 'Parameter.group'
        db.delete_column(u'wirm_parameter', 'group')
